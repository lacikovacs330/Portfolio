...
function About() {
  ...
  return (
    <section id="about" className="lg:h-[100vh] bg-gray-200 h-full" ref={sectionRef}>
      <div className="container page-wrapper mx-auto opacity-0 transition-opacity duration-500" style={{ opacity: isVisible ? 1 : 0 }}>
